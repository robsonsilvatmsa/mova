...
if (!empty($_POST['rdbInvestimento'])) {

    $function->update($id, $_SESSION['codprovisorio'], $_POST['rdbInvestimento'], $_POST['txtvalor']);
                    ...
                    <div class="panel-body">
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                ...
                                <?php $areaimp = $area->findById($itemMel->IdAreaImplantada);
                                if ($areaimp)
                        ...
                        <div class="form-inline">
                            ...
                            <div class="input-group mb-md">
                                ...
                                <input type="text" name="txtvalor" min="1" id="price" class="form-control">
                                <span class="input-group-addon ">,00</span>
                            </div>
                        </div>
                        <div class="row">
                            <ul id="anexos"></ul>
                            <iframe class="col-md-3" src="inclusao/upload.php" style="height: 36px; " frameborder="0"
                                    scrolling="no"></iframe>
                        </div> <!-- /.row -->
                        <div class="row">
                            <?php $anex = $anexos->find("idProvisorio = '$itemMel->id' and origem = 'melhoria'")->fetch(true); ?>
                            <?php
                            if ($anex):?>
                                <ul>
                                    <?php foreach ($anex as $itemanexo): ?>
                                        <li>
