...
<section role="main" class="content-body">
    ...
    <section class="panel">
        <header class="panel-heading">
            ...
            <h2 class="panel-title">Relatório Valor Recebido Por Grupo Melhoria</h2>
        </header>
    ...
    <section class="panel">
        <header class="panel-heading">
            ...
            <h2 class="panel-title">Relatório Valor Recebido Por Grupo Projeto</h2>
        </header>
        <div class="panel-body">
            <div class="table-striped">
...
<script type="text/javascript">
    function grafico() {
        ...
        function drawVisualization() {
            ...
            $.ajax({
                type: "POST",
                url: 'relatoriorecebidogrupomelhoria.php?to=' + to + "&end=" + end,
                dataType: 'json',
    ...
    function grafico1() {
        ...
        function drawVisualization1() {
            ...
            $.ajax({
                type: "POST",
                url: 'relatoriorecebidogrupoprojeto.php?to=' + to + "&end=" + end,
                dataType: 'json',
                success: function (data) {
