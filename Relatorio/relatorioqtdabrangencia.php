...
<section role="main" class="content-body">
    ...
    <section class="panel">
        <header class="panel-heading">
            ...
            <h2 class="panel-title">Relatório quantidade de projeto por abrangencia</h2>
        </header>
    ...
    <section class="panel">
        <header class="panel-heading">
            ...
            <h2 class="panel-title">Relatório quantidade de melhoria por abrangencia</h2>
        </header>
        <div class="panel-body">
            <div class="form-group">
                <div class="input-daterange input-group">
...
<script type="text/javascript">
    ...
    function grafico() {
        ...
        function drawVisualization() {
            ...
            $.ajax({
                type: "POST",
                url: 'relatorioqtdabrangenciaprojeto.php?to=' + to + "&end=" + end,
                dataType: 'json',
    ...
    function grafico1() {
        ...
        function drawVisualization1() {
            ...
            $.ajax({
                type: "POST",
                url: 'relatorioqtdabrangenciamelhoria.php?to=' + to + "&end=" + end,
                dataType: 'json',
                success: function (data) {
