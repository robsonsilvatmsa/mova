...
<section role="main" class="content-body">
    ...
    <section class="panel">
        <header class="panel-heading">
            ...
            <h2 class="panel-title">Relatório Valor Investido Por Projeto</h2>
        </header>
    ...
    <section class="panel">
        <header class="panel-heading">
            ...
            <h2 class="panel-title">Relatório Valor Investimento Por Melhoria</h2>
        </header>
...
<script type="text/javascript">
    ...
    function grafico() {
        ...
        function drawVisualization() {
            ...
            $.ajax({
                type: "POST",
                url: 'relatorioinvestimentomelhoria.php?to=' + to + "&end=" + end,
                dataType: 'json',
    ...
    function grafico1() {
        ...
        function drawVisualization1() {
            ...
            $.ajax({
                type: "POST",
                url: 'relatorioinvestimentoprojeto.php?to=' + to + "&end=" + end,
                dataType: 'json',
                success: function (data) {
