...
<section role="main" class="content-body">
    ...
    <section class="panel">
        <header class="panel-heading">
            ...
            <h2 class="panel-title">Relatório Valor Recebido Por Colaborador Projeto</h2>
        </header>
        <div class="panel-body">
            <div class="form-group">
                <form action="exportarrecebidousuarioprojeto.php" method="post">
    ...
    <section class="panel">
        <header class="panel-heading">
            ...
            <h2 class="panel-title">Relatório Valor Recebido Por Colaborador Melhoria</h2>
        </header>

        <div class="panel-body">
            <div class="form-group">

                <form action="exportarrecebidousuariomelhoria.php" method="post">
                    <div class="input-daterange input-group">
                            <span class="input-group-addon">
                                <i class="fa fa-calendar"></i>
                            </span>
...
<script type="text/javascript">
    ...
    function grafico() {
        ...
        function drawVisualization() {
            ...
            $.ajax({
                type: "POST",
                url: 'relatoriorecebidousuariomelhoria.php?to=' + to + "&end=" + end,
                dataType: 'json',
    ...
    function grafico1() {
        ...
        function drawVisualization1() {
            ...
            $.ajax({
                type: "POST",
                url: 'relatoriorecebidousuarioprojeto.php?to=' + to + "&end=" + end,
                dataType: 'json',
                success: function (data) {
