...
<section role="main" class="content-body">
    <header class="page-header">
        <h2>Analise de Eficácia de Projetos</h2>
        <div class="right-wrapper pull-right">
            <ul class="breadcrumbs">
                ...
                <li><span>Analise de Eficácia de Projetos</span></li>
            </ul>
    ...
    <section class="panel">
        ...
        <header class="panel-heading">
            ...
            <h2 class="panel-title">Analise de Eficácia de Projetos</h2>
                    ...
                    <?php if ($mel): ?>
                        <?php foreach ($mel as $value): ?>
                            <tr>
                                ...
                                <td class="actions">
                                    <a href="<?= BASEURL ?>Projeto/eficacia/edit.php?id=<?= $value->id ?>"
                                       data-toggle="tooltip"
